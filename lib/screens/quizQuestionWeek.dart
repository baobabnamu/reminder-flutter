...
class QuizList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void checkIdx() {
      if (quizSet!.length <= controller.quizWeekIndex) {
        controller.quizWeekIndex = 0;
      }
    }
    ...
    if (quizSet!.isEmpty) {
      return Text(
    ...
    } else if (!controller.quizWeekCardState) {
        controller.changeQuizWeekNowCardWord(quizSet![controller.quizWeekIndex].word);
        return Text(
          quizSet![controller.quizWeekIndex].word,
          style: TextStyle(
            color: Colors.indigo.shade900,
            fontSize: 35.0,
            fontWeight: FontWeight.w800,
        ...
        return Text(
          quizSet![controller.quizWeekIndex].mean,
          style: TextStyle(
            color: Colors.indigo.shade900,
            fontSize: 35.0,
            fontWeight: FontWeight.w800,
...
class QuizQuestionWeek extends StatelessWidget {
  const QuizQuestionWeek({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Future<http.Response> updateQuizSpace() {
      return http.put(
        ...
        body: jsonEncode(<String, dynamic>{
          'word': controller.quizWeekNowCardWord,
          'quizSpace': 4,
          'uid': controller.quizUser.value.email,
        }),
      );
          ...
          Align(
            child: SizedBox(
                ...
                child: GestureDetector(
                  ...
                  onTap: () {
                    controller.changeWeekCardState();
                    Navigator.push(
                      context,
                      MaterialPageRoute(
